        ...
        <TableBody>
          <TableRow sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
            ...
            <TableCell align="right">
              {row!=undefined && row.reward_quota_renewal_frequency!=undefined && row?.reward_quota_renewal_frequency <= 1 ? `${row?.reward_quota_renewal_frequency} month` : `${row?.reward_quota_renewal_frequency} months`} 
            </TableCell>
