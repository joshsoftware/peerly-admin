...
interface IProps {
  ...
  onAppreciationCardClickHandler: VoidFunction;
  onPostAppreciationClickHandler: VoidFunction;
}

const LandingPage = (props: IProps) => {
  const {
    onProfileClickHandler,
    onAppreciationCardClickHandler,
    onPostAppreciationClickHandler,
  } = props;
  return (
    <div>
      {/* header */}
      ...
      <div className="bg-[#F4F6FF]  mt-4">
        ...
        {/* List Leaderboard */}
        <ul className="flex gap-4 pl-6 mt-2 pb-14 overflow-auto scroll-smooth focus:scroll-auto">
          {/*List Element  */}
      ...
      <div className="h-[calc(100vh-320px)] mt-4 overflow-auto scroll-smooth px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          <AppreciationCard
            onAppreciationCardClick={onAppreciationCardClickHandler}
          />
          <AppreciationCard
            onAppreciationCardClick={onAppreciationCardClickHandler}
          />
      ...
      <button
        onClick={onPostAppreciationClickHandler}
        className="bg-[#3069F6] text-nowrap text-white text-base rounded-xl px-16 py-3 fixed bottom-6
